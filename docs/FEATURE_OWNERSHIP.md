...
| `tricks` | web domain feature | Trick picker/setup UI, catalog helpers, metadata, difficulty; routed games currently use flatground only | `@/features/tricks` | none | Static catalog | `npm test` when resolver/metadata changes |
