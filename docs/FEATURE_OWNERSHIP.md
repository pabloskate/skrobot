...
| `gallery` | web UI feature | Flatground trick gallery with stance filters, search, and optional curated video tips | `@/features/gallery` | none | Static tip catalog, empty until videos are curated | `npm run lint` |
