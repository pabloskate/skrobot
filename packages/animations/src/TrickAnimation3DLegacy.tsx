...
/**
 * Legacy snapshot of TrickAnimation3D, kept side-by-side for visual
 * comparison while the improved renderer is evaluated. Frozen on purpose:
 * fixes and polish land only in TrickAnimation3D.tsx; delete this file once
 * the new renderer is signed off. The physics is the same computeFrame the
...
export default function TrickAnimation3DLegacy({
  robot,
  trick,
  landed,
  onDone,
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={`Replay ${robot.name} attempting ${trick.name} in 3D legacy`}
