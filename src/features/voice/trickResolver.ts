...
const BASE_ALIASES: Record<string, string> = {
  ...
  'back 360': 'Backside 360',
  'bs 360': 'Backside 360',
  'three sixty back': 'Backside 360',
  'three sixty backside': 'Backside 360',
  'frontside 360': 'Frontside 360',
  'front 360': 'Frontside 360',
  'fs 360': 'Frontside 360',
  'three sixty front': 'Frontside 360',
  'three sixty frontside': 'Frontside 360',
  'backside flip': 'Backside Flip',
  'back flip': 'Backside Flip',
  'bs flip': 'Backside Flip',
  'backside kickflip': 'Backside Flip',
  'bs kickflip': 'Backside Flip',
  'frontside flip': 'Frontside Flip',
  'front flip': 'Frontside Flip',
  ...
  'bs heelflip': 'Backside Heelflip',
  'bs heel': 'Backside Heelflip',
  'frontside heelflip': 'Frontside Heelflip',
  'frontside heel': 'Frontside Heelflip',
  'front heel': 'Frontside Heelflip',
  'fs heelflip': 'Frontside Heelflip',
  'fs heel': 'Frontside Heelflip',
  'double heelflip': 'Double Heelflip',
  'double heel': 'Double Heelflip',
  'frontside 360 shuv': 'Frontside 360 Shuvit',
  'frontside 360 shuvit': 'Frontside 360 Shuvit',
  'frontside 360 shove it': 'Frontside 360 Shuvit',
  'fs 360 shuv': 'Frontside 360 Shuvit',
  'fs 360 shuvit': 'Frontside 360 Shuvit',
  'fs 360 shove it': 'Frontside 360 Shuvit',
  'bigspin flip': 'Bigspin Flip',
  'big flip': 'Bigspin Flip',
  'bigspin kickflip': 'Bigspin Flip',
  'bigkick': 'Bigspin Flip',
  'fs bigspin flip': 'FS Bigspin Flip',
  'frontside bigspin flip': 'FS Bigspin Flip',
  'front bigspin flip': 'FS Bigspin Flip',
  ...
  'fs bigspin heel': 'FS Bigspin Heelflip',
  'frontside bigspin heel': 'FS Bigspin Heelflip',
  'pressure flip': 'Pressure Flip',
  'pressure': 'Pressure Flip',
  'dolphin flip': 'Dolphin Flip',
  'dolphin': 'Dolphin Flip',
  'forward flip': 'Dolphin Flip',
  'forward': 'Dolphin Flip',
  'hospital flip': 'Hospital Flip',
  'hospital': 'Hospital Flip',
  'casper flip': 'Casper Flip',
  'casper': 'Casper Flip',
  'overcrooked grind': 'Overcrooked Grind',
  'overcrooked': 'Overcrooked Grind',
  'overcrook': 'Overcrooked Grind',
  'over crooks': 'Overcrooked Grind',
  'salad grind': 'Salad Grind',
  'salad': 'Salad Grind',
  'suski grind': 'Suski Grind',
  'suski': 'Suski Grind',
  'willy grind': 'Willy Grind',
  'willy': 'Willy Grind',
  'lazy grind': 'Willy Grind',
  'hurricane': 'Hurricane',
  'sugarcane': 'Sugarcane',
  'hippie jump': 'Hippie Jump',
  'hippy jump': 'Hippie Jump',
  'caveman': 'Caveman',
  'tail stall': 'Tail Stall',
  'tail': 'Tail Stall',
  'nose stall': 'Nose Stall',
  'nose': 'Nose Stall',
  'fakie bigspin stall': 'Fakie Bigspin Stall',
  'sweeper': 'Sweeper',
  'blunt to rock': 'Blunt to Rock',
  'blunt rock': 'Blunt to Rock',
  'noseblunt stall': 'Noseblunt Stall',
